							...
							<>
								<ShoppingListHeader>
									...
									<ButtonList>
										...
										<li>
											<IconButton icon="pencil-alt" bg="secondary" size="lg"
												onClick= {()=> window.toggleShoppingListModal('update', props.shoppingListSelected)}
											/>
										</li>
										<li>
											<IconButton icon="trash" bg="secondary" size="lg"
												onClick={ async () => {
													setIsListDeleting(props.shoppingListSelected._id);
													await props.onRemoveShoppingList(props.shoppingListSelected._id)
